...
class Customer(Base):
    ...
    person_type = Column(String(1), nullable=True)
...
class CompanyProfile(Base):
    ...
    nfce_ambiente = Column(String(1), nullable=True, default="2")
    nfce_serie = Column(String(3), nullable=True, default="001")
    nfce_cert_path = Column(String(255), nullable=True)
    nfce_cert_pass = Column(String(255), nullable=True)
    nfce_csc = Column(String(100), nullable=True)
    nfce_csc_id = Column(String(10), nullable=True)
...
class Product(Base):
    ...
    package_unit = Column(Integer, nullable=True)
